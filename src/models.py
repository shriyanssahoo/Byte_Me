...
class Course:
    ...
    is_pseudo_course: bool = False # Replaces is_pseudo_basket
    ...
    def _normalize_data(self):
        ...
        self.pre_post_preference = self.pre_post_preference.lower().strip() # Must be lowercase
